...
const navItems = [
  ...
  { icon: Grid2X2, label: "Mesas", href: "/tables" },
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div className="flex items-center gap-3 cursor-pointer group">
              <div className="hidden sm:block text-right">
                <p className="text-sm font-semibold leading-none text-foreground group-hover:text-primary transition-colors">João Silva</p>
              ...
              <Avatar className="h-9 w-9 border-2 border-border group-hover:border-primary transition-colors">
                <AvatarFallback className="bg-primary/10 text-primary font-medium">JS</AvatarFallback>
              </Avatar>
            </div>
          </div>
        </header>
